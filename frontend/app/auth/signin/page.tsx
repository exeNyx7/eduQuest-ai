    ...
    <main className="min-h-screen grid place-items-center p-6">
      <div className="max-w-md w-full">
        <div className="bg-gradient-to-br from-purple-600/30 to-pink-600/30 backdrop-blur-lg border-4 border-yellow-400/50 rounded-3xl p-10 text-center shadow-2xl">
          ...
          <h1 className="text-5xl font-bold mb-4 text-transparent bg-clip-text bg-gradient-to-r from-yellow-300 via-pink-300 to-purple-300">
            Join the Quest
          </h1>
          ...
          <button
            ...
            className="w-full mb-4 px-8 py-4 bg-white text-gray-900 text-lg font-bold rounded-xl shadow-lg hover:shadow-white/50 hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3"
          >
          ...
          <button
            ...
            className="w-full mb-6 px-8 py-4 bg-gray-900 text-white text-lg font-bold rounded-xl shadow-lg hover:shadow-gray-900/50 hover:scale-105 transition-all duration-200 flex items-center justify-center gap-3"
          >
